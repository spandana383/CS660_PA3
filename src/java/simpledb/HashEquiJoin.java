...
public class HashEquiJoin extends Operator {
    ...
    {
	return this.child1.getTupleDesc().getFieldName(this.pred.getField2());
    }
    ...
    private boolean loadMap() throws DbException, TransactionAbortedException {
        ...
        while (child1.hasNext()) {
            t1 = child1.next();
            ArrayList<Tuple> list = map.get(t1.getField(pred.getField2()));
            if (list == null) {
                list = new ArrayList<Tuple>();
                map.put(t1.getField(pred.getField2()), list);
            }
            list.add(t1);
            if (cnt++ == MAP_SIZE)
                return true;
